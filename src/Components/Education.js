...
<div className="intro">
            <div className="intro-text">
                ...
                <p>
                    <li><strong>Artificial Intelligence and Machine Learning:</strong> Acquired knowledge in AI and ML concepts such as supervised and unsupervised learning, decision trees, and neural networks, statistics, etc.  </li>        
